...
public class KMeansClusterer2 {
	...
	public void kMeansCluster() {
        ...
        for (int i = 0; i < iter; i++) {
            ...
            centroids = new double[k][dim]; // Moved initialization here
        ...
        clusters = bestClusters;  // Use the best clustering found
        centroids = bestCentroids; // Use the best centroids found
        System.out.println("Min WCSS: " + minWCSS);
    }
